...
exports.CreateUserAndUserAuthTables1632755466701 = void 0;
class CreateUserAndUserAuthTables1632755466701 {
    constructor() {
        this.name = 'CreateUserAndUserAuthTables1632755466701';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "users_auth_role_enum" AS ENUM('SUSPENSION_ROLE', 'USER_ROLE', 'ADMIN_ROLE', 'SU_ROLE')`);
...
exports.CreateUserAndUserAuthTables1632755466701 = CreateUserAndUserAuthTables1632755466701;
//# sourceMappingURL=1632755466701-CreateUserAndUserAuthTables.js.map